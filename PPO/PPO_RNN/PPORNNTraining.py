...
class Environment(gym.Env):
    ...
    def _initialize_positions(self):  # 初始化航天器位置信息
        ...
        escape = [0, 0, 0, 0, 0, 0]
        # chase = [42166.258669, 0.000000, 0.131020, 90.900407, 0.000000, 8.700026]
        # escape = [42103.858669, 0.000000, 0.131020, 90.900407, 0.000000, 7.900026]
